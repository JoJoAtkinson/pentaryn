...
starting-level: 1
hub-location: ardenford
---
# Ardenford Underdogs — Campaign Overview
...
These are the established names. Above ground, they're polite — even helpful — they'll buy you a drink, give you advice, sometimes warn you off a bad job. Below ground, in the ruins, the rules change. They will not always kill you for getting in their way. They might.
...
## How a delve works (player-facing)

1. **Find a job.** Posted at Thar'kar, given by an NPC, found in a rumor.
2. **Pay for the dive.** Each delve costs a fixed amount of gold — food, lamp oil, rope, splints. If you can't afford it, you don't go. (Starting kit covers the first one.)
...
- "Last crew I ran with disappeared in a ruin. People assume I sold them out."
- "I'm a deserter from somewhere I won't name."
- "I'm too young, my father's a known drunk, and I'm working my own name from zero."
- "I'm an Araethilion elf. The other elves don't talk to me anymore. Neither does anyone else."
- "I broke a contract. The Black Ledger has my mark. Nobody legitimate will sign with me."

## City politics — there if you want it

Ardenhaven is a constitutional monarchy ruled by the Council. There are guilds, district rivalries, an over-stretched militia, refugee quarters, and noble houses that quietly fund some of the bigger crews. None of that is required reading. **If you start asking who funds the Black Ledger, who really owns the sealed sub-levels, why the city tolerates the ruin economy at all — those threads exist and they will pull.** If you don't ask, the campaign stays focused on the next delve.
...
This world is shared with another campaign run by other players, but it is **not a shared story**. The other group exists in your world the way a storm exists — sometimes you'll hear that something happened somewhere ("a noble house just collapsed across town") and that's news, not setup. You will never be told you are "Group B." Your party is the only protagonist in this story. If you do something that diverges from how things go elsewhere, that's fine — the world bends around your table.
