...
**Tentacle Lash.** *Melee Weapon Attack:* +8 to hit, reach 10 ft., one target. *Hit:* 13 (3d6 + 3) bludgeoning damage, and the target is grappled (escape DC 16). The beholder has four tentacles; it can grapple up to four creatures at once. Each tentacle can be targeted separately (AC 15, 15 HP).
