...
- **Reaction priority — Oath-Breaking Retaliation:** auto-fires when hit by a visible attacker **within melee reach (5 ft)**; one Shrine-Axe counter-swing at the attacker. Self-damages 1d4 psychic regardless. OBR does NOT fire against ranged attackers, ranged-spell attackers, or area-effect damage (Fireball, etc.) — the shrine-touched cannot swing at someone not in reach. If the trigger is ambiguous (attacker just moved away), OBR does not fire.
