...
# Gar-Vally Encounter: Three Tiers

This encounter is designed for 3 PCs at level 4. It is structured as an escalating series of three scenes (tiers), each of which can pivot based on party choices. Approach A (Watcher Patrol, lore-forward) is the default; Approach B (Ambush, combat-first) is a fallback if the party shows up hostile.

## Custom Mechanics

These mechanics are used by multiple creatures. Define them once and apply them consistently.

### Sun-Burdened
**Used by:** Unnamed warriors, Hunt-Captain, Matron (in direct sunlight)

**Mechanic:** Disadvantage on attack rolls while in direct sunlight. At night or indoors, no penalty.

**Narrative:** The gnolls see the sun as a watcher, a burner, an outsider. Daylight is unsettling to them.

### Lunar Hunt
**Used by:** Hunt-Captain, Matron (at night, under moonlight)

**Mechanic:** When a moon is visible (night, outdoors), gain advantage on Stealth rolls and add 1d4 to the first attack roll of each round.

**Narrative:** The gnolls are most dangerous under moonlight. The moon is their mother.

### Eat the Fallen (Reaction)
**Used by:** All named gnolls (warriors, captain, lieutenant, matron)

**Trigger:** An ally gnoll (humanoid, not beast) drops to 0 HP within 5 feet.

**Mechanic:** This gnoll uses its reaction to "honour" the fallen. The gnoll gains 5 temporary HP and advantage on its next attack roll before the end of its next turn.

**Narrative:** The gnolls perform a quick rite over their fallen kin, absorbing their strength and memory. This is sacred, not grotesque.
...
**Mechanic:** If an unnamed Hunt-Lieutenant is within 5 feet and can perform a reaction, she may perform the *Rite of Succession*:
- The matron dies, but the lieutenant **gains the matron's spell list and features** for 1 minute (as if possessed).
- The lieutenant becomes the new matron for mechanical purposes.
- If the rite is completed, **Ancestor-Stir does NOT manifest**.

If no successor is within reach OR the party prevents the rite (e.g., grappling the lieutenant or destroying the matron's body):
...
**Narrative:** The matron does not die alone. She is eaten by her successor, and her wisdom flows into them. This is the apex of their culture: death is not ending, but inheritance.

---

## Tier 1A: Watcher Patrol (Approach A — Default, Lore-Forward)

**Location:** Road into Gar-Vally, dusk/sunset. Two stone outcroppings frame the path; the gnolls use them as a natural gate.

**Encounter:** 2× Unnamed Gnoll Warriors + 1 Valley Hyena, alert but not hostile.
...
**Encounter Mechanics:**
- The gnolls refuse to speak (treat the sun as hostile; they won't communicate in daylight).
- They communicate via signs, growls, and body language.
- They will NOT attack first—they are guards, not murderers.

**Skill Challenge (DC 12):** The party can attempt to parley using:
- **Insight (DC 12):** Reading their body language and intentions (they're guards, not murderers).
- **Animal Handling (DC 12):** Approaching the hyena, showing no threat.
- **Deception or Persuasion (DC 12):** Convincing them the party is harmless or worthy.
...
**Progression:** Regardless of outcome, Tier 2 begins as the party approaches the valley center.
...
**The Test:** Jorran (the scarred gnoll with the prospector's pickaxe—his victim-name is Jorran, a dwarf miner he ate) demands that the party offer a tribute: *something the party has killed, hunted, or taken.*
...
This is not a "yes," but it's not a "no." Raven will not be satisfied, but the door is open.

**The Reward (Non-Combat):**
- A *name-bone* (a carved token bearing one of the matron's eaten mothers' names and safe passage through gnoll territory)
...
The unnamed Hunt-Lieutenant uses her reaction to perform the **Rite of Succession:**
- She closes on the matron and performs the ritual eating (the matron dies, and the lieutenant gains the matron's spell list, hit points, and abilities for 1 minute).
- Combat continues with the "new" matron (the old one speaking through her successor).
- This is still a deadly fight. The party will likely need to flee.

If the party destroys the matron's body or prevents the rite, the **Ancestor-Stir** manifests next round—an undead hyena-spirit (CR 4) that is the echo of a previous matron. This is a CR 4 encounter, forcing a retreat.
...
```
Party on Dulgarum road
    ↓
[TIER 1: Road Entry]
├─ Tier 1A (default): Watcher Patrol
│   └─ Success (parley) OR Combat victory → proceed
├─ Tier 1B (fallback): Ambush (if hostile arrival)
│   └─ Victory OR Yield → proceed
    ↓
[TIER 2: Hunt-in-Progress]
├─ Parley success → skip combat
├─ Combat → hard fight
├─ Bypass (stealth) → cautious approach
    ↓
[TIER 3: Matron's Hearth]
├─ Social SUCCESS → Passage + Name-bone
├─ Combat attempted → Vessel of Mothers / Ancestor-Stir
└─ Retreat with knowledge → Lore confirmed
```
...
1. **Names are critical:** Every named gnoll (Jorran, the matron) has a victim-name. Don't skip this—it's the entire thematic weight.
2. **The Matron's Names:** She carries 3-4 eaten matrons' names. Layer them in her introduction.
3. **Sun-Burdened and Lunar Hunt are environmental levers:** These make environment matter tactically.
4. **The Rite of Succession is the emotional climax:** If the party kills the matron, her successor eating her is the moment they understand: these are not monsters.
5. **Raven's quest is a thread, not a knot:** Keep it unresolved. The matron will not convert, but she will listen.
