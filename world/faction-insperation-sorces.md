...
This is a **real-world inspiration map** for each in-world faction: aesthetics, institutions, values, and “how they behave under pressure.”
...
- Function:
  ...
  - Trades in favors and wards, not territory; acts case-by-case rather than by treaty.
  - Raises and trains witches bound to the Voice; keeps power deliberately unseen.
- Inspiration sources:
  - **European cunning-folk & service magic** — Timeline: c. 1500–1750 CE — Village warding, charmcraft, feared/respected “helpers,” secrecy shaped by witch-hunt panic.
...
- Function:
  ...
  - “Good governance under strain”: rebuilding after war, balancing ideals with survival.
  - Diplomacy-forward realm trying to remain independent from imperial expansion.
- Inspiration sources:
  - **Roman Republic (mixed constitution)** — Timeline: c. 509–133 BCE — Civic virtue as identity, tension between elite councils and popular assemblies, law as legitimacy.
...
- Function:
  ...
  - Raids framed as survival and spirit-law enforcement, not simple conquest.
  - An exodus culture: survival doctrine, sacred-site protection, paranoia after betrayal.
- Inspiration sources:
  - **Mongol political confederation (kurultai tradition)** — Timeline: c. 1206–1368 CE — Coalition governance, leadership by mandate and performance, rapid mobilization, diplomacy and terror as tools.
...
- Function:
  ...
  - Dispute resolution via honor-debt and compensation (blood-price) instead of endless feuds.
  - Treaty-minded confederation: stable when oaths are kept, terrifying when they aren’t.
- Inspiration sources:
  - **Icelandic Commonwealth (Alþingi assemblies)** — Timeline: c. 930–1262 CE — Law spoken into being, arbitration culture, feuds managed through courts and settlement.
...
- Function:
  ...
  - Prosperity and pride on the surface; secrecy, casualties, and suppression beneath.
  - Leadership that treats “oath-matters” as absolute—law, religion, and survival fused.
- Inspiration sources:
  - **Sparta (duty-first civic culture)** — Timeline: c. 650–371 BCE — Communal endurance, identity as service, suspicion of softness, survival framed as discipline.
...
- Function:
  ...
  - Banking, arbitration, and “licensed crime” as governance; information as currency.
  - Oligarchs preserve neutrality by making everyone dependent on the Gate.
- Inspiration sources:
  - **Venetian Republic (merchant oligarchy)** — Timeline: c. 1000–1797 CE — Council politics, state-as-commerce, diplomatic neutrality as leverage, masks/ceremony as social technology.
...
- Function:
  ...
  - Innovation, arms exports, and arbitration sold to all sides; neutrality weaponized.
  - A modern-feeling engine of wealth with moral rot at the labor and debt edges.
- Inspiration sources:
  - **Song dynasty commercial-industrial boom (China)** — Timeline: c. 960–1279 CE — Large-scale iron production, engineering culture, monetized administration, logistics-first power.
...
- Function:
  ...
  - Beauty and abundance sustained by ritual obligation and quiet coercion.
  - Surveillance and exile used to protect the myth of harmony and eternal bloom.
- Inspiration sources:
  - **New Kingdom Egypt (divine kingship & temple-state)** — Timeline: c. 1550–1070 BCE — Ruler-as-sacred axis, ritual calendar governing society, priestly administration as state machinery.
...
- Function:
  ...
  - Predictable law as both promise and weapon; compliance rewarded, defiance crushed.
  - Quiet pursuit of “deterrents” beyond acceptable norms to preserve dominance.
- Inspiration sources:
  - **Roman imperial statecraft (roads, legions, citizenship)** — Timeline: c. 27 BCE–200 CE — Standardization, frontier administration, law as unity, military professionalism as identity.
  - **Qin legalism and early imperial bureaucracy (China)** — Timeline: c. 221–206 BCE — Uniform codes, registers, harsh enforcement, state capacity built on documentation.
  - **Napoleonic-era administrative reform (code, prefects, merit)** — Timeline: c. 1799–1815 CE — Central ministries, standardized law, modern-style provincial administration and permits.
