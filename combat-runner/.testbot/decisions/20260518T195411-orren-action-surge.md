# Testbot decision — orren-action-surge

- **Run timestamp:** `20260518T195411`
- **Scenario:** Orren burns Action Surge — slot count 0/1, refresh on long_rest only
...
```
TestbotFailure: assert_slot on orren.action_surge: expected 0, got <unset>
```
...
- Look at `.testbot/runs/20260518T195411-orren-action-surge.json` for the full metrics.
- Reproduce by running: `.venv/bin/python combat-runner/testbot/run_one_scenario.py --id orren-action-surge`
