# Testbot decision — zorgar-rage-frenzy

- **Run timestamp:** `20260516T114006`
- **Scenario:** Zor'gar enters rage, then frenzy — slot decrement + greataxe combo
...
```
TestbotFailure: assert_slot on zor-gar.rage: expected 2, got <unset>
```
...
- Look at `.testbot/runs/20260516T114006-zorgar-rage-frenzy.json` for the full metrics.
- Reproduce by running: `.venv/bin/python combat-runner/testbot/run_one_scenario.py --id zorgar-rage-frenzy`
