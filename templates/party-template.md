...
Create one member page per character at `members/<member-slug>.md` using `templates/party-member-abilities-template.md`.
...
- If any member breaks a `rare` / `very_rare` origin rule, record the reason here.
...
### Conditions, Boons, & Debts

- 

### Session Log (Party-Level)

- **Session XX (YYYY-MM-DD):** Summary of party-wide changes (relationships, inventory, levels, deaths, new members)
