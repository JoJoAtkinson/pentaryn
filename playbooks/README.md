...
Operational how-to guides for tools we drive by hand or by agent — as opposed to
`templates/` (content skeletons), `scripts/` (code), or `world/` (lore).

A playbook answers *"how do I actually do this thing, and what will bite me."*
Point Claude at one when you want the procedure followed without re-deriving it.
